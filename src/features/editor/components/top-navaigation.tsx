...
const Tab = ({
  ...
  const { activeTab, previewTab, setActiveTab, openFile, closeTab } =
    useEditor(projectId);

  const isActive = activeTab === fileId;
  const isPreview = previewTab === fileId;
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          "p-0.5 rounded-sm hover:bgwhite/10 opacity-0 group-hover:opacity-100",
